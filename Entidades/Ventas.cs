...
namespace Entidades
{
	public class Ventas
	{
		...
		public Decimal GetTotalFacturado()
		{
			return ven_total_facturado;
		}
		...
		//SETS
		public void SetCodigo(int ven_codigo)
		{
		...
		public void SetFecha(DateTime ven_fecha)
		{
			this.ven_fecha = ven_fecha;
		}
		public void SetTotalFacturado(Decimal ven_total_facturado)
		{
			this.ven_total_facturado = ven_total_facturado;
		}
