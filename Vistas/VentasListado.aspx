                                ...
                                <div class="card-body card bg-light">
                                    <div class="row">
                                        <div class="col-md-3 text-left">
                                            ...
                                            <asp:RangeValidator ID="RvTxtCliente" runat="server" ControlToValidate="TxtCliente" ErrorMessage="*Ingresar un número válido (de ocho dígitos)" ForeColor="Red" MaximumValue="99999999" MinimumValue="0" Type="Integer" ValidationGroup="buscar">*</asp:RangeValidator>
                                        </div>
                                        <div class="col-md-3 text-left">
