						...
						<div class="card-header">
							<div class ="row">
									...
									<h5 class="h2 card-title mb-0">Listado de Marcas</h5>
											...
											<div class="col-md-6">
											<asp:LinkButton ID="LnAgregarMarcs" class="btn btn-outline-dark float-right" runat="server" OnClick="LnAgregarMarcas_Click">+ Agregar Marcas</asp:LinkButton>
							</div>
							...
							<asp:GridView ID="GrdMarcas" runat="server" AutoGenerateColumns="False"
								...
								CssClass="table display" OnRowCommand="GrdMarcas_RowCommand">
								<Columns>
									...
									<asp:TemplateField HeaderText="Logo">
										<ItemTemplate>
											...
											<asp:HiddenField ID="urlImage" runat="server" Value='<%# Eval("mar_ruta_imagen") %>' />
										</ItemTemplate>
									</asp:TemplateField>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label>Eslógan</label>
						<asp:TextBox ID="TxtEsloganModal" runat="server" class="form-control form-control-lg"></asp:TextBox>
					</div>
					<div class="form-group">
						<label>Código</label>
